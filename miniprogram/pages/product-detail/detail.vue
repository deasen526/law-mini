<template>
  <view class="page" v-if="product">
    ...
    <view class="card guarantee-card" v-if="product.guarantee">
      <view class="guarantee-text">🛡️ {{ product.guarantee }}</view>
    </view>
...
.cover-placeholder { width: 200rpx; height: 200rpx; border-radius: 12rpx; flex-shrink: 0; background: linear-gradient(135deg, #e3f2fd, #bbdefb); display: flex; align-items: center; justify-content: center; font-size: 80rpx; }
...
.card { background: #fff; border-radius: 16rpx; margin: 20rpx; padding: 28rpx; box-shadow: 0 2rpx 8rpx rgba(0,0,0,0.03); }
.card-title { font-size: 30rpx; font-weight: 600; color: #333; margin-bottom: 18rpx; }
.scenario-text { font-size: 28rpx; color: #555; line-height: 1.7; }
.roi-card { background: linear-gradient(135deg, #e8f5e9, #c8e6c9); }
.roi-hint { font-size: 28rpx; color: #2e7d32; line-height: 1.7; }
.feature-item { font-size: 28rpx; color: #555; padding: 10rpx 0; line-height: 1.6; border-bottom: 1rpx solid #f5f5f5; }
.feature-item:last-child { border-bottom: none; }
.process-item { display: flex; margin-bottom: 24rpx; }
.process-item:last-child { margin-bottom: 0; }
.step-num { width: 48rpx; height: 48rpx; background: #1a6fb5; color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 24rpx; font-weight: 600; flex-shrink: 0; margin-right: 20rpx; }
.step-title { font-size: 28rpx; font-weight: 500; color: #333; }
.step-desc { font-size: 24rpx; color: #999; margin-top: 4rpx; }
.case-item { padding: 18rpx 0; border-bottom: 1rpx solid #f5f5f5; }
...
.guarantee-text { font-size: 28rpx; color: #ff9800; text-align: center; }
...
.btn-buy { background: linear-gradient(135deg, #f44336, #e53935); color: #fff; font-size: 32rpx; font-weight: 500; padding: 20rpx 64rpx; border-radius: 44rpx; border: none; }
